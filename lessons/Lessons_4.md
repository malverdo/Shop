# 4. Урок 4 DDL: создание, изменение и удаление объектов в PostgresSQL
- Задание: Используя операторы DDL создайте на примере схемы интернет-магазина:

## Schema
![schema.png](../images/lessons_4/schema.png)

## [Role](../Deployment/DataBaseInit/Postgres/create_role.sql)
```sql
create user "shop_root" with password 'root';
GRANT ALL PRIVILEGES ON DATABASE "shop" to shop_root;
```

## [DataBase](../Deployment/DataBaseInit/Postgres/create_database.sql)
```sql
create DATABASE shop;
```

## [Create schema](../Deployment/DataBaseInit/Postgres/create_schema.sql)
```sql
...
## [Create tables](../Deployment/DataBaseInit/Postgres/create_tables.sql)
```sql
